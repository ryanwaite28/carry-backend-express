...
module.exports = (env) => {
  ...
  const MAIN_ENTRY_FILE = path.resolve(__dirname, 'src', 'main.app.ts');
  const PUSH_ALERTS_WORKER_ENTRY_FILE = path.resolve(__dirname, 'src', 'workers', 'push-new-listings-alerts.worker.ts');
